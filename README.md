...
| tenable | 针对路由设备的 BadUsb 攻击 | https://github.com/tenable/router_badusb | http://www.tenable.com/ |  | Columbia, MD | 25 | 3 | 0 | C,Shell,Java,Python,C++,Vim,CoffeeScript,HTML,Emacs,Ruby,PowerShell | 259 | 101 | 1| 
...
| outflanknl | Excel4-DCOM - 通过 DCOM 远程执行 Excel 4.0/XLM 宏实现横向渗透的利用脚本 | https://github.com/outflanknl/Excel4-DCOM | http://www.outflank.nl | Clear advice with a hacker mindset. Red Teaming - Digital Attack Simulation - Incident Detection and Response | Amsterdam, Netherlands, EU | 15 | 0 | 0 | C,Shell,Python,C++,PowerShell,CSS | 0 | 0 | 1| 
...
| xuechiyaobai | Pwn2Own 2019 Firefox IonMonkey MArraySlice 别名信息错误导致远程代码执行漏洞（CVE-2019-9810）的 POC | https://github.com/xuechiyaobai/CVE-2019-9810-PoC/ | None |  | None | None | 22 | 0 | 143 | 121 | 25 | C,HTML,JavaScript,C++ | 105 | 30 | 1| 
...
| vishnudxb | automated-pentest - 用于运行自动化扫描和生成渗透测试报告的 Parrot OS 系统容器 | https://github.com/vishnudxb/automated-pentest | http://www.vishnudxb.me | Vishnu Nair is working as a Technology Lead in Taylor & Francis | The Netherlands | None | 127 | 0 | 176 | 30 | 54 | Go,Python,Shell,Ruby | 82 | 9 | 1| 
...
| rootbsd | fridump3: A universal memory dumper using Frida for Python... | https://github.com/rootbsd/fridump3 | None |  | Europa | None | 19 | 0 | 3 | 9 | 0 | Python,Objective-C++ | 81 | 13 | 1| 
