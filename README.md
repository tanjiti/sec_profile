...
| Cryptogenic | 在 PS4 6.20 上的 WebKit 远程代码执行漏洞（CVE-2018-4441）利用 | https://github.com/Cryptogenic/PS4-6.20-WebKit-Code-Execution-Exploit | https://twitter.com/SpecterDev | PHP/C++ developer with an interest in user-land and web exploitation. | None | None | 28 | 0 | 38 | 612 | 5 | Go,C,JavaScript,HTML | 591 | 153 | 1| 
